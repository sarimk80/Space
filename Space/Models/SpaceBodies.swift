...
struct Bodies : Identifiable, Codable{
    ...
    let isPlanet:Bool//": false,
    let moons:[Moons]?//": null,
    let semimajorAxis:Int?//": 384400,
    let perihelion:Int?//": 363300,
    let aphelion:Int?//": 405500,
    let eccentricity:Double?//": 0.0549,
    let inclination:Double?//": 5.145,
    let mass:Mass?
    //      ": {
    //      "massValue": 7.346,
    //      "massExponent": 22
    ...
    //      "volExponent": 10
    //    },
    let density:Double?//": 3.344,
    let gravity:Double?//": 1.62,
    let escape:Double?//": 2380,
    let meanRadius:Double?//": 1737,
    let equaRadius:Double?//": 1738.1,
    let polarRadius:Double?//": 1736,
    let flattening:Double?//": 0.0012,
    let dimension:String?//": "",
    let sideralOrbit:Double?//": 27.3217,
    let sideralRotation:Double?//": 655.728,
    ...
    let axialTilt:Double?//": 6.68,
    let avgTemp:Double?//": 0,
    let mainAnomaly:Double?//": 0,
    let argPeriapsis:Double?//": 0,
    let longAscNode:Double?//": 0,
    let bodyType:String?//": "Moon",
...
var dummyBodies:[Bodies]=[
    
    Bodies(id: "s2003j2", name: "S/2003 J 2", englishName: "S/2003 J 2", isPlanet: false, moons: nil, semimajorAxis: 28570410, perihelion: 0, aphelion: 0, eccentricity: 0.38, inclination: 151.8, mass: Mass(massValue: 1.5, massExponent: 13), vol: nil, density: 1, gravity: 0, escape: 0, meanRadius: 1, equaRadius: 0, polarRadius: 0, flattening: 0, dimension: "", sideralOrbit: 982.5, sideralRotation: 0, aroundPlanet: AroundPlanet(planet: "jupiter", rel: "https://api.le-systeme-solaire.net/rest/bodies/jupiter"), discoveredBy: "Scott S. Sheppard, David C. Jewitt", discoveryDate: "2003", alternativeName: "S/2003 J 2", axialTilt: 0, avgTemp: 0, mainAnomaly: 0, argPeriapsis: 0, longAscNode: 0, bodyType: "Moon", rel: "https://api.le-systeme-solaire.net/rest/bodies/s2003j2"),
